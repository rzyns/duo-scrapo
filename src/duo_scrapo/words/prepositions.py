...
from duo_scrapo.words import SupportsAnkiExport, SupportsEmpty
...
@define
class PrepositionForms(BasePrepositionForms, SupportsAnkiExport, SupportsEmpty[BasePrepositionForms]):
    @classmethod
    def get_cols(cls):
        return (
            "preposition",
...
model = Model(
    ...
    fields=[
        {"name": col}
        for col in ("en", "pl", *PrepositionForms.get_cols())
    ],
    templates=[
        asdict(a)
        for a in templates
