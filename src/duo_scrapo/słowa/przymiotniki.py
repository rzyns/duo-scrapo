...
from duo_scrapo.słowa import FormyPrzypadków, Gendered, GenderedPlural, GenderedSingular
...
@define
class FormyPrzymiotników(Gendered[FormyPrzypadków]):
    liczba_pojedyncza: GenderedSingular[FormyPrzypadków[str]]
    liczba_mnoga: GenderedPlural[FormyPrzypadków[str]]
...
model = Model(
    ...
    fields=[
        {"name": col}
        for col in ("en", "pl", *FormyPrzymiotników.get_cols())
    ],
    templates=[
        asdict(a)
        for a in templates
